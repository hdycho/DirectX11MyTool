...
public:
	...
	void Local(D3DXMATRIX& matrix, bool isLocal = false)
	{ 
		local = matrix;
		ChangeLocal = matrix;
		isLocalChange = isLocal;
	}
	D3DXMATRIX GetChangeLocal() { return ChangeLocal; }
	bool IsChangeLocal() { return isLocalChange; }
