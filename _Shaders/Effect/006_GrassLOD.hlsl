...
////////////////////////////////////////////////////////////////////////////////////
void VS(in VSINPUT input, out GEO_IN output)
{
...
////////////////////////////////////////////////////////////////////////////////////
void GS(point GEO_IN points[1], in uint vertexDifference, inout TriangleStream<GEO_OUT> output)
{
...
////////////////////////////////////////////////////////////////////////////////////
float4 PS(in GEO_OUT input) : SV_TARGET
{
...
technique11 T0
{
    pass Pass0
    {
        ...
        SetGeometryShader(CompileShader(gs_5_0, GS_LOD1()));
        SetPixelShader(CompileShader(ps_5_0, PS()));
    }
    pass Pass1
    {
        SetVertexShader(CompileShader(vs_5_0, VS()));
        SetGeometryShader(CompileShader(gs_5_0, GS_LOD2()));
        SetPixelShader(CompileShader(ps_5_0, PS()));
    }
    pass Pass2
    {
        SetVertexShader(CompileShader(vs_5_0, VS()));
        SetGeometryShader(CompileShader(gs_5_0, GS_LOD3()));
        SetPixelShader(CompileShader(ps_5_0, PS()));
    }
    pass Pass3
    {
        SetVertexShader(CompileShader(vs_5_0, VS()));
        SetGeometryShader(CompileShader(gs_5_0, GS_LOD4()));
        SetPixelShader(CompileShader(ps_5_0, PS()));
    }
}
