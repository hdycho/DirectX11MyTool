...
MeshSphere::MeshSphere(Material* material, float radius, UINT stackCount, UINT sliceCount, Effect*lineShader)
	: Mesh(material, lineShader), radius(radius), stackCount(stackCount), sliceCount(sliceCount)
{
	CreateData();
}
...
void MeshSphere::ColliderUpdate()
{
