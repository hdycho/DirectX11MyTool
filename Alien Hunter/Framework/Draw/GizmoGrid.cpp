...
void GizmoGrid::ResetLines()
{
	...
	{
		vertexArray.push_back(new VertexColor(D3DXVECTOR3((float)(i * spacing), 0.0f, (float)gridSize), lineColor));
		vertexArray.push_back(new VertexColor(D3DXVECTOR3((float)(i * spacing), 0.0f, (float)-gridSize), lineColor));
														  
		vertexArray.push_back(new VertexColor(D3DXVECTOR3((float)(-i * spacing), 0.0f, (float)gridSize), lineColor));
		vertexArray.push_back(new VertexColor(D3DXVECTOR3((float)(-i * spacing), 0.0f, (float)-gridSize), lineColor));
														  
		vertexArray.push_back(new VertexColor(D3DXVECTOR3((float)gridSize, 0.0f, (float)i * spacing), lineColor));
		vertexArray.push_back(new VertexColor(D3DXVECTOR3((float)-gridSize, 0.0f, (float)(i * spacing)), lineColor));
