...
public:
	...
	void WritePixels(DXGI_FORMAT writeFormat, vector<D3DXCOLOR>& pixels,Texture&copy, bool isInteger = false);
...
public:
	...
	TextureArray(vector<ID3D11Texture2D *>& textures, UINT width = 256, UINT height = 256, UINT mipLevels = 1);
	~TextureArray();
