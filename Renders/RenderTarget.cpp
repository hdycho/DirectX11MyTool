...
RenderTarget::RenderTarget(struct ExecuteValues*values, UINT width, UINT height)
	:values(values)
{
	//랜더타겟 크기설정
	{
	...
	//Create Texture - RTV용
	{
		...
		textureDesc.Format = DXGI_FORMAT_R32G32B32A32_FLOAT;//정밀도를 높이기위해
...
void RenderTarget::SaveRTVTextrue(wstring saveFile)
{
